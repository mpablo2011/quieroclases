...
// Autor: Pablo Maroli                                    //
////////////////////////////////////////////////////////////
$app->get('/getClientLocation', function (Request $request, Response $response) {
        ...
        try {
                ...
                $consulta = "call cli_getclientlocation(:userID);";
...
// Autor: Pablo Maroli                                    //
////////////////////////////////////////////////////////////
$app->post('/insertclientlocation', function (Request $request, Response $response) {
...
if ($userID != '')
{
    try {
        ...
        // Preparar sentencia
        $consulta = "call cli_insClientLocation(:userID, :countryID, :stateProvinceID, :cityID, :streetAddress, :lat, :lng);";
